...
import { Accordion,  AccordionSummary, Drawer, List, ListItem, ListItemButton, useMediaQuery } from "@mui/material";
...
return (
    <div className="container" style={{display:"flex",marginBottom:"20px",justifyContent:"space-between",alignItems:"center",marginTop:"25px"}}>
        <div className="category" style={{display:"flex",justifyContent:"space-between",alignItems:"center",width:"30%",backgroundColor:theme.palette.mycolor.main,padding:"10px",borderRadius:"10px"}}>
        ...
        {useMediaQuery('(max-width:1200px)') && (<MenuIcon style={{cursor:"pointer"}} onClick={toggleDrawer("top", true)}/>)}
        ...
        <div style={{width:"100%",height:"100vh",position:"relative"}}>
            <div style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"700px",height:"500px"}}>
                <box style={{position:"absolute",top:"30%",right:"30%",padding:"10px"}}>
                ...
                <box style={{width:"30px",position:"absolute",top:"0px",right:"0px"}}>
                    <CloseIcon  sx={{":hover":{rotate:"180deg",transition:"0.3s",color:"red"},top:"120px",right:"700px",position:"absolute"}} onClick={toggleDrawer("top", false)} />
                </box>
            </div>
        </div>
