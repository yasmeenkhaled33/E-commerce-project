...
export default function Hrader2 () {
    ...
    return (
        <div className="container" style={{display:"flex",marginBottom:"20px",justifyContent:"space-between",alignItems:"center",paddingTop:"20px"}}>
            ...
            <div>
            <Search className="searchh" sx={{ display:"flex",minWidth:"600px",borderRadius:"22px",justifyContent:"space-between",padding:"0px"}}>
                <SearchIconWrapper >
                <SearchIcon />
                </SearchIconWrapper>
                <StyledInputBase
            ...
            <div  style={{paddingBottom:"0"}} className='right'>
                <Link to="/buy">
                    <IconButton aria-label="cart">
                        <StyledBadge badgeContent={buynum} color="primary">
                            <ShoppingCartIcon/>
                        </StyledBadge>
                    </IconButton>
                </Link>
